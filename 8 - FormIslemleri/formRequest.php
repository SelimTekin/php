...
<body>
    ...
    <form action="sonucRequest.php" method="get">
    ...
    <!-- <form action="sonucRequest.php" method="post">
        Adınız Soyadınız : <input type="text" name="adSoyad"><br/>
        E-Mail Adresiniz : <input type="email" name="email"><br/>
        Telefonunuz : <input type="text" name="telefon"><br/>
        Cinsiyetiniz : <input type="radio" name="cinsiyet" value="erkek"> Erkek <input type="radio" value="kadin"> Kadın<br/>
        Yaşınız : <select name="yas" id="yas">
            <option value=""></option>
            <option value="20">20</option>
            <option value="21">21</option>
