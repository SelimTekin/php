...
<body>
    <!-- <form action="sonucCheckboxRequest.php" method="get">
        Adınız Soyadınız : <input type="text" name="adSoyad">
        Hobileriniz : 
        <input type="checkbox" name="hobiler[]" value="alisveris"> Alışveriş <!-- hobiler[] yaparak dizi halinde gönderdik -->
    ...
    <form action="sonucCheckboxRequest.php" method="post">
        Adınız Soyadınız : <input type="text" name="adSoyad">
        Hobileriniz : 
        <input type="checkbox" name="hobiler[]" value="alisveris"> Alışveriş <!-- hobiler[] yaparak dizi halinde gönderdik -->
        <input type="checkbox" name="hobiler[]" value="seyahat"> Seyahat
